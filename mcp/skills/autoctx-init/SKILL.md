---
name: autoctx-init
description: Orchestrates the initialization workflow for auto context generation, and provides helper workflows for creating or updating `tools.yaml` configurations.
---
